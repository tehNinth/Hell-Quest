...
uses
  ...
  DataManager in 'DataManager.pas' {DataManagerForm},
  HellViewer in 'HellViewer.pas' {HellViewerForm},
  SWFMenu in 'SWFMenu.pas' {SWFMenuForm};
...
begin
  ...
  Application.CreateForm(TDataManagerForm, DataManagerForm);
  Application.CreateForm(THellViewerForm, HellViewerForm);
  Application.CreateForm(TSWFMenuForm, SWFMenuForm);
  Application.Run;
end.
